...
function supplementalFiles() {
  return [require('cldr-data/supplemental/currencyData.json'), require('cldr-data/supplemental/likelySubtags.json'), require('cldr-data/supplemental/numberingSystems.json'), require('cldr-data/supplemental/ordinals.json'), require('cldr-data/supplemental/plurals.json'), require('cldr-data/supplemental/timeData.json'), require('cldr-data/supplemental/weekData.json')];
}
...
var _default = (function () {
  ...
  function _default(locale, currencyCode) {
    ...
    var localeData = new Cldr(locale);
