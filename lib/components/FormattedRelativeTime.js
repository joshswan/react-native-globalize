...
var FormattedRelativeTime = function (_Component) {
  ...
  function FormattedRelativeTime() {
    ...
    return _possibleConstructorReturn(this, (FormattedRelativeTime.__proto__ || Object.getPrototypeOf(FormattedRelativeTime)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      if (value instanceof Date) {
        ...
        if (unit === 'best') {
          ...
          for (var i = 0, l = units.length; i < l; i += 1) {
      ...
      var formatRelativeTime = this.context.globalize.getRelativeTimeFormatter(unit, {
