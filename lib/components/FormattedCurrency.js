...
var FormattedCurrency = function (_Component) {
  ...
  function FormattedCurrency() {
    ...
    return _possibleConstructorReturn(this, (FormattedCurrency.__proto__ || Object.getPrototypeOf(FormattedCurrency)).apply(this, arguments));
  }
  ...
  _createClass(FormattedCurrency, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          style = _props.style,
          value = _props.value,
          other = _objectWithoutProperties(_props, ['currency', 'style', 'value']);
