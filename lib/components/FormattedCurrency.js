...
var FormattedCurrency = (function (_Component) {
  ...
  function FormattedCurrency(props, context) {
    ...
    _get(Object.getPrototypeOf(FormattedCurrency.prototype), 'constructor', this).call(this, props, context);
  }

  _createClass(FormattedCurrency, [{
    key: 'render',
    value: function render() {
      var formatCurrency = this.context.globalize.getCurrencyFormatter(this.props.currency, this.props);

      var formattedCurrency = formatCurrency(this.props.value);
