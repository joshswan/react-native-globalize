...
var FormattedPlural = (function (_Component) {
  ...
  function FormattedPlural(props, context) {
    ...
    _get(Object.getPrototypeOf(FormattedPlural.prototype), 'constructor', this).call(this, props, context);
  }
  ...
  _createClass(FormattedPlural, [{
    ...
    value: function render() {
      ...
      var pluralCategory = formatPlural(this.props.value);
...
FormattedPlural.propTypes = _extends({}, _types.pluralFormatPropTypes, {
  ...
  other: _reactNative.PropTypes.node.isRequired,
  zero: _reactNative.PropTypes.node,
  one: _reactNative.PropTypes.node,
  two: _reactNative.PropTypes.node,
  few: _reactNative.PropTypes.node,
  many: _reactNative.PropTypes.node
});
